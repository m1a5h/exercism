...
(defun verse (n)
  ...
  (case n
    ...
    (2 (format nil "~d bottles of beer on the wall, ~d bottles of beer.~%Take one down and pass it around, ~d bottle of beer on the wall.~%" n n (1- n)))
  (otherwise (format nil "~d bottles of beer on the wall, ~d bottles of beer.~%Take one down and pass it around, ~d bottles of beer on the wall.~%" n n (1- n)))))
